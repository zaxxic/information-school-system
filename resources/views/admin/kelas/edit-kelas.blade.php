...
@section('fluid')
    <div class="container-fluid">
        ...
        <form class="mt-4" action="{{ route('kelas1.update', $class->id) }}" enctype="multipart/form-data" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="modal-body">
                ...
                <div class="">
                    ...
                    <select class="form-control" name="class_category_id" id="">
                        ...
                        <option value="1" {{ $class->class_category_id == 1 ? 'selected' : '' }}>1</option>
                        <option value="2" {{ $class->class_category_id == 2 ? 'selected' : '' }}>2</option>
                        <option value="3" {{ $class->class_category_id == 3 ? 'selected' : '' }}>3</option>
                        <option value="4" {{ $class->class_category_id == 4 ? 'selected' : '' }}>4</option>
                        <option value="5" {{ $class->class_category_id == 5 ? 'selected' : '' }}>5</option>
                        <option value="6" {{ $class->class_category_id == 6 ? 'selected' : '' }}>6</option>
                    </select>
