        ...
        <div class="row">
            ...
            @foreach ($ekstra as $item)
                <div class="col-lg-4 col-md-6">
                    <div class="card">
                        <img class="card-img-top img-responsive" src="{{ asset('storage/ekstra/' . $item->photo) }}"
                            alt="Card image cap">
                        <div class="card-body">
                            <div class="d-flex">
                            ...
                            <div class="row d-flex justify-content-between">
                                ...
                                <a href="{{ route('ekstra.edit', ['ekstra' => $item->id]) }}"
                            ...
                            <form id="delete-form-{{ $item->id }}"
                                action="{{ route('announcement.destroy', ['announcement' => $item->id]) }}"
